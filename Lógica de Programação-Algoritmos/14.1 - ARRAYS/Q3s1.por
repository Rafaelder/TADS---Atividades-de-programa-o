    ...
    funcao removerValor(inteiro valor, inteiro tamanho)
    {
        ...
        para (i = 0; i < tamanho; i++){     // Loop para percorrer o vetor e encontrar o valor a ser removido	  
            se (numeros[i] == valor) {           
                ...
                para (j = i; j < tamanho - 1; j++) {     // Remove o valor deslocando os elementos subsequentes para a esquerda
                    numeros[j] = numeros[j + 1]
                }
                // O último elemento do vetor é substituído por um valor padrão (opcional)
                numeros[tamanho - 1] = 0
            }
        }
       mostrarValVetor()
